      ...
      <div className="container-narrow">
        ...
        <div className="mt-14 grid gap-5 sm:grid-cols-3">
          {problems.map((item) => (
            <article
              key={item.title}
              className="glass-panel group p-6 transition duration-200 hover:-translate-y-0.5 hover:shadow-[0_12px_40px_rgba(28,25,23,0.08)]"
            >
              <div className="inline-flex rounded-xl bg-accent-soft p-3 text-accent transition group-hover:bg-accent group-hover:text-on-primary">
