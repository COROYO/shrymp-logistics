  ...
  return (
    <section className="section-pad">
      <div className="container-narrow">
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-primary via-primary to-brand-navy px-6 py-14 text-center sm:px-12 sm:py-16">
          <div
            className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,rgba(161,98,7,0.25),transparent_55%)]"
            aria-hidden
          />
          <div className="relative mx-auto max-w-2xl">
            ...
            <p className="mt-4 text-lg leading-relaxed text-stone-300">
              Verbinde deinen Shopify-Shop und teste Monolith im echten Betrieb.
              Setup in Minuten — kein Sales-Call nötig.
            </p>
            <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
              <a
                href={logisticsUrl}
                className="btn-primary min-w-[200px] bg-accent hover:bg-accent-hover"
              >
                Beta starten
